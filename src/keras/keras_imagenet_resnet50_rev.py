...
#parser.add_argument('--train-dir', default=os.path.expanduser('/apps/applications/singularity_images/imagenet/train'), help='path to validation data')
parser.add_argument('--train-dir', default=os.path.expanduser('/pscratch/sd/s/swhwang/imagenet/train'),
                    help='path to training data')
#parser.add_argument('--val-dir', default=os.path.expanduser('/apps/applications/singularity_images/imagenet/val'), help='path to validation data')
parser.add_argument('--val-dir', default=os.path.expanduser('/pscratch/sd/s/swhwang/imagenet/val'),
