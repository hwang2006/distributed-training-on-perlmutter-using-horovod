...
#parser.add_argument('--train-dir', default=os.path.expanduser('/scratch/qualis/dataset/training_set/training_set'), help='path to training data')
#parser.add_argument('--train-dir', default=os.path.expanduser('/pscratch/sd/s/swhwang/git-projects/dataset/training_set/training_set'), help='path to training data')
parser.add_argument('--train-dir', default=os.path.expanduser('/pscratch/sd/s/swhwang/ddl-projects/dataset/training_set/training_set'), help='path to training data')
#parser.add_argument('--val-dir', default=os.path.expanduser('/scratch/qualis/dataset/test_set/test_set'), help='path to validation data')
#parser.add_argument('--val-dir', default=os.path.expanduser('/pscratch/sd/s/swhwang/git-projects/dataset/test_set/test_set'), help='path to validation data')
parser.add_argument('--val-dir', default=os.path.expanduser('/pscratch/sd/s/swhwang/ddl-projects/dataset/test_set/test_set'), help='path to validation data')
...
#train_dir = "/pscratch/sd/s/swhwang/git-projects/dataset/training_set/training_set"
train_dir = "/pscratch/sd/s/swhwang/ddl-projects/dataset/training_set/training_set"
#valid_dir = "/scratch/qualis/dataset/test_set/test_set"
#valid_dir = "/pscratch/sd/s/swhwang/git-projects/dataset/test_set/test_set"
valid_dir = "/pscratch/sd/s/swhwang/ddl-projects/dataset/test_set/test_set"
