...
```
- to run the Bert NSMC (Naver Sentiment Movie Corpus) example in the [src/pytorch-lightning](https://github.com/hwang2006/distributed-training-on-perlmutter-using-horovod/tree/main/src/pytorch-lightning) directory, you need to install additional packages (i.e., emoji, soynlp, transformers and pandas) and download the nsmc datasets, for example, using git cloning
```
